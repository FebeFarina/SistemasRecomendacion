...
Lo siguiente que vemos en el código es como recoje y procesa los datos que entran por linea de comandos. Estos comandos serian el nombre del fichero donde estan los datos a cargar, y el segundo el tipo de métrica que queremos usar para calcular la distancia entre vectores.
